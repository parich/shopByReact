                    ...
                    <div className="card card-body">
                        <ul>
                            ...
                            <il>
                                <div className="row">
                                    <div>Items</div>
                                    <div>{cart.itemsPrice.toFixed(2)}{' '}Bath</div>
                                </div>
                                <div className="row">
                                    <div>Shipping</div>
                                    <div>{cart.shippingPrice.toFixed(2)}{' '}Bath</div>
                                </div>
                                <div className="row">
                                    <div>Tax</div>
                                    <div>{cart.taxPrice.toFixed(2)}{' '}Bath</div>
                                </div>
                                <div className="row">
                                    <div><strong>Order Total</strong></div>
                                    <div><strong>{cart.totalPrice.toFixed(2)}{' '}Bath</strong></div>
                                </div>
                            </il>
                            <li>
                                <button type="button"
